...
def cassandraDataToDataframe():
    ...
    try:
        ...
        logger.error("Call method cassandraDataToDataframe() error!")
        logger.error("Exception:" + str(ex))
        raise ex
...
def merge_device_data_and_common_car_info():
    ...
    try:
        ...
        logger.error("Call method merge_device_data_and_common_car_info() error!")
        logger.error("Exception:" + str(ex))
        raise ex
...
def delete_not_need_analysis_data_from_merge_device_data():
    ...
    try:
        ...
        logger.error("Call method delete_not_need_analysis_data_from_merge_device_data() error!")
        logger.error("Exception:" + str(ex))
        raise ex
...
def splitCarAndPersonToCSV():
    ...
    try:
        ...
        logger.error("Call method splitCarAndPersonToCSV() error!")
        logger.error("Exception:" + str(ex))
        raise ex
...
def draw_with_folium_all_points_maker_style():
    ...
    try:
        ...
        logger.error("Call method draw_with_folium_all_points_maker_style() error!")
        logger.error("Exception:" + str(ex))
        raise ex
...
def splitMonthDataToDayData():
    ...
    try:
        ...
        logger.error("Call method splitMonthDataToDayData() error!")
        logger.error("Exception:" + str(ex))
        raise ex
...
def use_everyday_data_to_draw_with_folium_maker():
    ...
    try:
        ...
        logger.error("Call method use_everyday_data_to_draw_with_folium_maker() error!")
        logger.error("Exception:" + str(ex))
        raise ex
...
def use_everyday_stay_more_than_5_minutes_to_generate_month_csv():
    ...
    try:
        ...
        logger.error("Call method use_everyday_stay_more_than_5_minutes_to_generate_month_csv() error!")
        logger.error("Exception:" + str(ex))
        raise ex
...
def dbscan_get_device_center_coordinates():
    ...
    try:
        ...
        logger.error("Call method dbscan_get_device_center_coordinates() error!")
        logger.error("Exception:" + str(ex))
        raise ex
...
def draw_with_folium_all_points_and_dbscan_center_circle_style():
    ...
    try:
        ...
        logger.error("Call method draw_with_folium_all_points_and_dbscan_center_circle_style() error!")
        logger.error("Exception:" + str(ex))
        raise ex
...
def save_device_center_by_year():
    ...
    try:
        ...
        logger.error("Call method save_device_center_by_year() error!")
        logger.error("Exception:" + str(ex))
        raise ex
...
def draw_with_folium_by_device_and_year_dbscan_center_circle_style():
    ...
    try:
        ...
        logger.error("Call method draw_with_folium_by_device_and_year_dbscan_center_circle_style() error!")
        logger.error("Exception:" + str(ex))
        raise ex
...
def save_screen_shot(para_url):
    ...
    try:
        ...
        logger.error("Call method save_screen_shot() error!")
        logger.error("Exception:" + str(ex))
        raise ex
...
def downLoadDataToCsvFromContectRemoteDatabase():
    ...
    try:
        ...
        logger.error("Call method downLoadDataToCsvFromContectRemoteDatabase() error!")
        logger.error("Exception:" + str(ex))
        raise ex
...
def draw_with_echarts(para_csv_path_name,para_csv_name,para_save_path):
    try:
        ...
        logger.error("Call method draw_with_echarts() error!")
        logger.error("Exception:" + str(ex))
        raise ex
...
def draw_with_dbscan(para_csv_path_name,para_csv_name,para_save_path):
    try:
        ...
        logger.error("Call method draw_with_dbscan() error!")
        logger.error("Exception:" + str(ex))
        raise ex
